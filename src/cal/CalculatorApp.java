...
public class CalculatorApp extends JFrame {
	...
	private static final long serialVersionUID = 1796068686082214256L;
	public JButton btnAdd, btnSubtract, btnDivide, btnMultiply, btnClear, btnDelete, btnEquals, btnDot;
	public JButton numBtn[];
	public JTextField output;
	public String previous, current, operator;
    ...
    public CalculatorApp() {
        ...
        output.setMaximumSize(new Dimension(305, 280));
